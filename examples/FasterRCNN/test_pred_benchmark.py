...
if __name__ == '__main__':
    ...
    parser.add_argument('--individual-benchmarking', help='Get result for all individual frames images, current in multiple categories')
  
    argms = ['--config', 'DATA.BASEDIR="/home/dataset/batch_3_1" MODE_FPN=True "DATA.VAL=("hologram_val",)"  "DATA.TRAIN=("hologram_train",)"', '--load-pb', '',
    #              '--load_ckpt', 'True',
